...
async def seed():
    ...
    sample_students = [
        ...
        },
        {
            ...
            "delivery_address": "Girls Hostel 2, Room 304",
            "delivery_notes": "Please leave at security desk",
        ...
        },
        {
            ...
            "diet_preference": "NON_VEG",
            "delivery_preference": "DELIVERY",
            "delivery_address": "Boys Hostel 1, Room 112",
    ...
    for s in sample_students:
        ...
        worker_doc = {
            ...
            "delivery_preference": s.get("delivery_preference", "DINE_IN"),
