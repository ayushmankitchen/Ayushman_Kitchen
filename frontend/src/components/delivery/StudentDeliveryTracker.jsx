...
export default function StudentDeliveryTracker({ worker }) {
  ...
  useEffect(() => {
    setLoading(true);
    load();
    return startVisiblePolling(load, data?.is_out_for_delivery ? 10000 : 30000);
