...
const WEEKDAYS = [
  { en: "Mon", full: "Monday" },
  { en: "Tue", full: "Tuesday" },
  { en: "Wed", full: "Wednesday" },
  { en: "Thu", full: "Thursday" },
  { en: "Fri", full: "Friday" },
  { en: "Sat", full: "Saturday" },
  { en: "Sun", full: "Sunday" },
];
...
export default function AttendanceCalendar({
  ...
  }, [isAdmin, workerId, year, month, selectedDay]);
  ...
  return (
    <div
      ...
      className={`bg-white border border-stone-200 rounded-3xl p-4 sm:p-6 shadow-xs ${className}`}
    >
        ...
        <div className="flex flex-wrap items-center justify-between gap-4 pb-4 mb-4 border-b border-stone-100">
          <div className="flex items-center gap-3">
            <WorkerAvatar
              ...
              size="lg"
              className="shadow-xs border border-stone-200 shrink-0"
            />
            <div>
              ...
              <p className="text-xs text-slate-500 mt-0.5">
                ...
                {workerInfo.joining_date && (
                  <span className="ml-2 text-slate-400">· Joined: {workerInfo.joining_date}</span>
                )}
              </p>
            </div>
          </div>
        ...
        <>
          ...
          <div className="grid grid-cols-2 sm:grid-cols-5 gap-2 sm:gap-3 mb-5" data-testid="attendance-summary-cards">
            <div className="bg-emerald-50/70 border border-emerald-200/80 rounded-2xl p-3 text-center sm:text-left">
              ...
              <span className="text-[10px] text-emerald-600/90 font-medium">days</span>
            </div>
            ...
            <div className="bg-amber-50/70 border border-amber-200/80 rounded-2xl p-3 text-center sm:text-left">
              ...
              <span className="text-[10px] text-amber-600/90 font-medium">days</span>
            </div>
            ...
            <div className="bg-rose-50/70 border border-rose-200/80 rounded-2xl p-3 text-center sm:text-left">
              ...
              <span className="text-[10px] text-rose-600/90 font-medium">days</span>
            </div>
                ...
                return (
                  ...
                  >
                    ...
                    <div className="flex items-center justify-between w-full">
                      ...
                      {is_today && (
                        <span className="text-[9px] font-extrabold uppercase tracking-tight bg-teal-800 text-white px-1 rounded">
                          Today
                        </span>
                      )}
                    </div>
            ...
            >
              ...
              {isAdmin && !selectedDay.is_future && (
                <div className="flex flex-wrap items-center gap-1.5">
                  ...
                  >
                    <Clock className="h-3.5 w-3.5 mr-1" /> Half Day
                  </Button>
                  <Button
                    type="button"
                    size="sm"
